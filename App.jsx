...
function useRealtimeSync(setVentas, setInv, setRetiros) {
  useEffect(() => {
    ...
    getSupabase().then(db => {
      if (!mounted) return;
      channel = db.channel("toscana-realtime-v3")
        // ── Venta nueva ────────────────────────────────────────────────────
        .on("postgres_changes", { event: "INSERT", schema: "public", table: "ventas" }, async payload => {
          ...
          try {
            ...
            if (mounted) setVentas(prev =>
              prev.some(x => x.id === venta.id) ? prev : [...prev, venta]
            );
          } catch(e) { console.warn("[RT] venta insert:", e.message); }
        })
        ...
        .on("postgres_changes", { event: "INSERT", schema: "public", table: "inventario" }, payload => {
          ...
          if (mounted) setInv(prev =>
            prev.some(x => x.id === prod.id) ? prev : [...prev, prod]
          );
        })
...
const MARCAS_SEED = [
  {id:1,  nombre:"Donaire",       color:"#A8C5A0", emoji:"✨",
   imagen:"data:image/svg+xml;base64,"},
  {id:2,  nombre:"Ramona",        color:"#F4A8A8", emoji:"🌸",
   imagen:"data:image/svg+xml;base64,"},
  {id:3,  nombre:"Materia",       color:"#A8D4B0", emoji:"🌿",
   imagen:"data:image/svg+xml;base64,"},
  {id:4,  nombre:"Dual",          color:"#A8BCD4", emoji:"◈",
   imagen:"data:image/svg+xml;base64,"},
  {id:5,  nombre:"Sensually",     color:"#F4A8C8", emoji:"💫",
   imagen:"data:image/svg+xml;base64,"},
  {id:6,  nombre:"Glowphoria",    color:"#F4D4A8", emoji:"✦",
   imagen:"data:image/svg+xml;base64,"},
  {id:7,  nombre:"Monas",         color:"#C8A8D4", emoji:"🔮",
   imagen:"data:image/svg+xml;base64,"},
  {id:8,  nombre:"Bonita",        color:"#F4BCA8", emoji:"🌺",
   imagen:"data:image/svg+xml;base64,"},
  {id:9,  nombre:"She",           color:"#A8D4C4", emoji:"◎",
   imagen:"data:image/svg+xml;base64,"},
  {id:10, nombre:"Ellá",          color:"#D4C4A8", emoji:"🍂",
   imagen:"data:image/svg+xml;base64,"},
  {id:11, nombre:"Magenta",       color:"#D4A8BC", emoji:"◆",
   imagen:"data:image/svg+xml;base64,"},
  ...
  {id:14, nombre:"Minimal",       color:"#C4C4C4", emoji:"◻",
   imagen:"data:image/svg+xml;base64,"},
  {id:15, nombre:"Comfy",         color:"#C8B8A8", emoji:"☁",
   imagen:"data:image/svg+xml;base64,"},
  {id:16, nombre:"Essenza",       color:"#D4C8A0", emoji:"🕊",
   imagen:"data:image/svg+xml;base64,"},
  {id:17, nombre:"Doña Mamushka", color:"#F4ACA8", emoji:"🎀",
   imagen:"data:image/svg+xml;base64,"},
  {id:18, nombre:"Shalé",         color:"#ACBCAC", emoji:"◠",
   imagen:"data:image/svg+xml;base64,"},
...
// Carga xlsx-js-style (fork de SheetJS con soporte de estilos de celda)
// Drop-in replacement: misma API + propiedad .s en celdas para colores/bordes
...
async function generarPlantillaXLSX(){
  ...
  // ── Paleta editorial Toscana House ──────────────────────────
  // Sin # — formato RRGGBB que exige xlsx-js-style
  const D  = "1A1714"; // chocolate oscuro  → fondo título
  const G  = "9A7B4F"; // oro               → cols obligatorias, subtítulo
  const GL = "C4A57B"; // oro claro         → bordes req
  const GD = "6B4A28"; // oro oscuro        → texto sobre ámbar
  const CR = "F5F0E8"; // crema cálida      → meta/versión
  const CL = "FAF7F3"; // crema muy clara   → filas alternadas
  const WH = "FFFFFF"; // blanco            → filas base datos
  const AM = "FDF3DC"; // ámbar             → fila de aviso
  const AB = "E8C97A"; // ámbar borde
  const BD = "D4C5A9"; // borde cálido
  const MT = "8B7355"; // texto muted gris-dorado
  ...
  const bMedBot = (bot=G, side=BD) => ({
    top:{style:"thin",color:{rgb:side}}, bottom:{style:"medium",color:{rgb:bot}},
    left:{style:"thin",color:{rgb:side}}, right:{style:"thin",color:{rgb:side}},
  });
  ...
  const sHdrReq = {                   // encabezado columna OBLIGATORIA ★
    font:{name:"Arial",sz:11,bold:true,color:{rgb:WH}},
    fill:{patternType:"solid",fgColor:{rgb:G}},
    alignment:{horizontal:"center",vertical:"center",wrapText:true},
    border:bAll(GL),
  };
  const sHdrOpt = {                   // encabezado columna opcional
    font:{name:"Arial",sz:11,bold:true,color:{rgb:WH}},
    fill:{patternType:"solid",fgColor:{rgb:D}},
    alignment:{horizontal:"center",vertical:"center",wrapText:true},
    border:bAll("2A2420"),
  };
  const sDataL = (alt) => ({         // dato — texto izquierda
    font:{name:"Arial",sz:10,color:{rgb:D}},
    fill:{patternType:"solid",fgColor:{rgb:alt?CL:WH}},
    alignment:{horizontal:"left",vertical:"center",wrapText:true},
    border:bAll(BD),
  });
  const sDataC = (alt) => ({         // dato — centrado
    font:{name:"Arial",sz:10,color:{rgb:D}},
    fill:{patternType:"solid",fgColor:{rgb:alt?CL:WH}},
    alignment:{horizontal:"center",vertical:"center",wrapText:true},
    border:bAll(BD),
  ...
  const sBlank = {
    fill:{patternType:"solid",fgColor:{rgb:WH}}, border:bAll(BD),
  };
  const sSeccion = {                  // titulo de sección (instrucciones)
    font:{name:"Arial",sz:10,bold:true,color:{rgb:D}},
    fill:{patternType:"solid",fgColor:{rgb:CR}},
    alignment:{horizontal:"left",vertical:"center"},
    border:bMedBot(G,BD),
  };
  const sClave = {                    // clave izquierda (instrucciones)
    font:{name:"Arial",sz:10,bold:true,color:{rgb:G}},
    fill:{patternType:"solid",fgColor:{rgb:WH}},
    alignment:{horizontal:"left",vertical:"center",wrapText:true},
    border:bAll(BD),
  };
  const sValor = {                    // valor derecha (instrucciones)
    font:{name:"Arial",sz:10,color:{rgb:D}},
    fill:{patternType:"solid",fgColor:{rgb:WH}},
    alignment:{horizontal:"left",vertical:"center",wrapText:true},
    border:bAll(BD),
  ...
  const rows1 = [
    ...
    ["Version: "+HOY+"  ·  Completar columnas ★ y enviar a Toscana House",...Array(NC-1).fill("")],
  ...
  XLSX.utils.book_append_sheet(wb, ws2, "Marcas");
  ...
  INSTR.forEach((x,r)=>{
    if(x.t==="title")         { Srow(ws3,r,2,sTitulo);  }
    else if(x.t==="blank")    { Srow(ws3,r,2,sBlank);   }
    else if(x.t==="section")  { S(ws3,r,0,sSeccion); S(ws3,r,1,sSeccion); }
    else                      { S(ws3,r,0,sClave);   S(ws3,r,1,sValor);   }
  });
...
function parseMixtoXls(metodoPago, total) {
  if (metodoPago?.startsWith("mixto|")) {
    ...
    // Gift Card tratada como efectivo en liquidación (ya se cobró cuando se vendió la GC)
...
// ── Generar imagen (captura) de la liquidación de marca ──────────────────────
...
// ── Descargar imagen de la liquidación de marca ───────────────────────────────
  ...
  return (
    <div>
      ...
      <div style={{background:C.bg2,borderRadius:16,padding:"18px 20px",
        ...
        border:`1px solid ${C.sep}`,marginBottom:16}}>
        <div>
          <div style={{fontSize:28,fontWeight:700,color:C.gold,fontFamily:FONT,lineHeight:1}}>
            {cajas.length} cajas
          </div>
        ...
        <div style={{display:"flex",gap:24}}>
          <div style={{textAlign:"center"}}>
            <div style={{fontSize:22,fontWeight:700,color:C.green,fontFamily:FONT}}>{abiertas}</div>
            <div style={{fontSize:11,color:C.label3,fontFamily:FONT}}>Cajas abiertas</div>
          </div>
          <div style={{textAlign:"center"}}>
            <div style={{fontSize:22,fontWeight:700,color:C.amber,fontFamily:FONT}}>{porAbrir}</div>
...
function ImportarExcelModal({inv, onImportar, onClose, onArchivoCapturado}){
  ...
  const [verif,      setVerif]      = useState(null); // verificación post-carga
  const fileRef = useRef(null);
  ...
  async function parsearArchivo(file){
    ...
    try{
      ...
      function parseStock(raw){
        if(raw===null||raw===undefined||raw==="") return 0; // sin valor = no sumar
        const s = String(raw).replace(/[^\d]/g,"");
        const n = parseInt(s);
        return isNaN(n) ? 0 : n; // siempre lo que dice el Excel, exacto
      }
  ...
  // ── Verificación post-carga: confirma 2-3 veces que cada código    ──
  // ── importado quedó realmente en el inventario (cubre escrituras   ──
  // ── asíncronas a Supabase que pueden tardar unos segundos).         ──
  useEffect(()=>{
    if(estado!=="done"||!stats||!stats.codigosEsperados?.length) return;
    let cancelado=false;
    const timers=[];
    const delays=[1200,3000,6000]; // hasta 3 verificaciones
  ...
  // ── Reintentar verificación manualmente ────────────────────────────
  function reverificar(){
    ...
    setTimeout(()=>{
      ...
      const faltantes = stats.codigosEsperados.filter(c=>!presentes.has(c));
      setVerif({
        intento:(verif?.intento||0)+1, faltantes,
        confirmados: stats.codigosEsperados.length - faltantes.length,
        total: stats.codigosEsperados.length,
        checking:false,
      });
  ...
  // ── Exportar Excel con los códigos pendientes (omitidos + no confirmados) ──
  async function exportarPendientes(){
    const XLSX = await loadXLSX();
    const pendientes = [];
    (stats?.omitidos||[]).forEach(o=>pendientes.push({
      sku:o.sku, desc:o.desc, marca:o.marca, motivo:o.errs.join("; ")||"Omitido",
    }));
    (verif?.faltantes||[]).forEach(cod=>{
      const f = preview.find(p=>p.sku.toUpperCase()===cod);
      pendientes.push({
        sku:cod, desc:f?.desc||"", marca:f?.marcaNombre||"",
        motivo:"No se confirmó en el inventario tras la carga — reintentar",
      });
    });
    const rows = [
      ["Código","Descripción","Marca","Motivo"],
    ...
    <Sheet open title="Importar Excel — Inventario" onClose={onClose} tall>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr 1fr",gap:8,marginBottom:16}}>
            {[
              ...
              <div key={s.l} style={{background:C.bg2,borderRadius:12,padding:"10px 8px",
                ...
                <div style={{fontSize:20,fontWeight:700,color:s.c,fontFamily:FONT_UI}}>{s.v}</div>
      ...
      {estado==="done"&&stats&&(
        <div style={{textAlign:"center",padding:"20px 0"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:10,marginBottom:16}}>
            {[
              ...
              <div key={s.l} style={{background:C.bg2,borderRadius:14,padding:"14px 10px",
                textAlign:"center",border:`1px solid ${s.c}25`}}>
                <div style={{fontSize:28,fontWeight:700,color:s.c,fontFamily:FONT_UI}}>{s.v}</div>
          ...
          {verif && stats.codigosEsperados?.length>0 && (
            <div style={{
              ...
              {verif.checking ? (
                <div style={{fontSize:13,fontWeight:700,color:C.gold,fontFamily:FONT_UI}}>
                  🔄 Verificando carga… (intento {verif.intento}/3) — confirmando {verif.confirmados}/{verif.total} códigos en inventario
                </div>
              ) : verif.faltantes.length===0 ? (
                <div style={{fontSize:13,fontWeight:700,color:C.green,fontFamily:FONT_UI}}>
                  ✅ Verificado: los {verif.total} códigos de este lote están confirmados en el inventario.
                </div>
              ) : (
                <div>
                  <div style={{fontSize:13,fontWeight:700,color:C.red,fontFamily:FONT_UI,marginBottom:8}}>
                    ⚠ {verif.faltantes.length} de {verif.total} códigos NO se confirmaron en el inventario tras 3 verificaciones
                  </div>
                  <div style={{fontFamily:"monospace",fontSize:11,color:C.label,lineHeight:1.6,
                    background:C.bg1,borderRadius:8,padding:"8px 10px",marginBottom:10,
                    maxHeight:100,overflowY:"auto",border:`1px solid ${C.sep}`}}>
                    {verif.faltantes.join(", ")}
                  </div>
                  <div style={{display:"flex",gap:8}}>
                    <button onClick={reverificar}
                      style={{flex:1,background:C.bg1,border:`1px solid ${C.red}40`,borderRadius:10,
                        padding:"9px",fontSize:12,fontWeight:700,color:C.red,cursor:"pointer",fontFamily:FONT_UI}}>
                      🔁 Reintentar verificación
                    </button>
                    <button onClick={exportarPendientes}
                      style={{flex:1,background:C.bg1,border:`1px solid ${C.red}40`,borderRadius:10,
                        padding:"9px",fontSize:12,fontWeight:700,color:C.red,cursor:"pointer",fontFamily:FONT_UI}}>
          ...
          {/* ── Filas omitidas por error (no se intentaron cargar) ── */}
          {stats.omitidos?.length>0 && (
            <div style={{
              background:`${C.amber}08`, border:`1.5px solid ${C.amber}35`,
              borderRadius:16, padding:"14px 16px", marginBottom:16, textAlign:"left",
            }}>
              <div style={{fontSize:13,fontWeight:700,color:C.amber,fontFamily:FONT_UI,marginBottom:8}}>
                ⚠️ {stats.omitidos.length} código{stats.omitidos.length!==1?"s":""} del Excel NO se cargó por error de datos
              </div>
              <div style={{display:"flex",flexDirection:"column",gap:4,maxHeight:120,overflowY:"auto",
                marginBottom:10}}>
                {stats.omitidos.map((o,i)=>(
                  <div key={i} style={{fontSize:11,fontFamily:FONT_UI,color:C.label,
                    display:"flex",justifyContent:"space-between",gap:8,
                    background:C.bg1,borderRadius:6,padding:"4px 8px"}}>
                    <span style={{fontFamily:"monospace",fontWeight:700,color:C.gold,flexShrink:0}}>{o.sku}</span>
                    <span style={{color:C.red,textAlign:"right"}}>{o.errs.join("; ")}</span>
                  </div>
                ))}
              </div>
              <button onClick={exportarPendientes}
                style={{width:"100%",background:C.bg1,border:`1px solid ${C.amber}40`,borderRadius:10,
                  padding:"9px",fontSize:12,fontWeight:700,color:C.amber,cursor:"pointer",fontFamily:FONT_UI}}>
                ⬇ Descargar Excel con códigos pendientes
              </button>
            </div>
          )}
          ...
          <div style={{display:"grid", gridTemplateColumns:"1fr 1fr", gap:8}}>
            {[
              ...
              <div key={p.label} style={{
                ...
                <div style={{fontSize:16, fontWeight:600, color:p.color, fontFamily:FONT_UI}}>
        ...
        <div style={cardStyle}>
          ...
          {ultVentas.map((v, i) => (
            <div key={v.id || i} style={{
              display:"flex", justifyContent:"space-between", alignItems:"center",
              padding:"7px 0",
              borderBottom: i < ultVentas.length - 1 ? `1px solid ${C.sep}` : "",
            }}>
              <div style={{flex:1, minWidth:0}}>
        ...
        <div style={{padding:"18px 20px 14px",borderBottom:`1px solid ${C.sep}`,
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:14}}>
            <div>
              ...
              <div style={{fontSize:20,fontWeight:600,color:C.label,fontFamily:FONT_DISPLAY,
                display:"flex",alignItems:"center",gap:10}}>
                {f.imagen
  ...
  return (
    <div style={overlay} onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div style={card}>
        ...
        {/* QR code — para imprimir o escanear en caja */}
        <div style={{display:"flex",alignItems:"center",gap:20,marginBottom:20,
          background:C.bg2,borderRadius:14,border:`1px solid ${C.sep}`,padding:"16px"}}>
          <div style={{flexShrink:0,background:"#fff",borderRadius:10,padding:8,
            boxShadow:"0 2px 8px rgba(0,0,0,0.08)"}}>
            <BarcodeDisplay codigo={gc.codigo}/>
          </div>
          <div style={{flex:1,minWidth:0}}>
            <div style={{fontSize:11,fontWeight:700,color:C.label3,textTransform:"uppercase",
...
function InventarioPorMarca({inv, ventas, retiros=[], onRecibir, onBaja, onImportarExcel, onReponer, onSyncCompleto, onRecargarDesdeSupabase}){
  ...
  function abrirVentasPorCodigoInv(prod) {
    ...
    if (lista.length===1) { setVentaAbiertaInv({...sorted[0], _codigoOrigen:prod.codigo}); return; }
    setVentasCodigoInv({codigo:prod.codigo, lista: sorted});
  }
  const [ventaAbiertaInv, setVentaAbiertaInv] = useState(null);
  const dragRef = React.useRef({dragging:false, ox:0, oy:0, x:null, y:null});
  ...
  return (
    <div>
      ...
      {/* ── Ventana arrastrable nota de venta ── */}
    {(ventasCodigoInv||ventaAbiertaInv)&&(()=>{
      const cerrarTodo = ()=>{ setVentaAbiertaInv(null); setVentasCodigoInv(null); setDragPos(null); };
      ...
      const titleBar = (label, onClose)=>(
        <div onMouseDown={onDragStart}
          style={{display:"flex",justifyContent:"space-between",alignItems:"center",
            padding:"11px 14px",background:C.bg2,borderBottom:`1px solid ${C.sep}`,
            cursor:"grab"}}>
          <span style={{fontSize:11,fontWeight:700,letterSpacing:1,textTransform:"uppercase",
            color:C.label3,fontFamily:FONT_UI}}>{label}</span>
      ...
      if (ventaAbiertaInv) {
        ...
        return (
          <div data-drag-window style={winStyle}>
            {titleBar("Nota de venta", cerrarTodo)}
            <div style={{padding:"16px 18px",borderBottom:`1px solid ${C.sep}`}}>
              ...
              <span style={{fontSize:10,fontFamily:"monospace",color:C.label3,
                background:C.bg2,padding:"2px 8px",borderRadius:5,border:`1px solid ${C.sep}`}}>{codigo}</span>
            </div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:0}}>
              {[
                ...
                <div key={i} style={{padding:"12px 18px",borderBottom:`1px solid ${C.sep}`,
                  ...
                  {f.vendedor!==undefined ? (
                    <div style={{display:"flex",alignItems:"center",gap:8}}>
                      <div style={{width:28,height:28,borderRadius:"50%",background:C.bg2,
                        border:`1px solid ${C.sep}`,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
                        <span style={{fontSize:11,fontWeight:700,color:C.label,fontFamily:FONT_UI}}>{f.iniciales}</span>
                      </div>
                      <span style={{fontSize:13,fontWeight:700,color:C.label,fontFamily:FONT}}>{f.vendedor}</span>
                    </div>
                  ) : (
                    <div>
      ...
      return (
        <div data-drag-window style={winStyle}>
          {titleBar(`${lista.length} ventas — ${codigo}`, cerrarTodo)}
            ...
            {lista.map((v,i)=>(
              <div key={v.id||i}
                ...
                style={{display:"flex",justifyContent:"space-between",alignItems:"center",
                  ...
                  cursor:"pointer"}}>
                <div>
                  <div style={{fontSize:13,fontWeight:700,color:C.label,fontFamily:FONT}}>{v.fecha}</div>
                  <div style={{fontSize:11,color:C.label3,fontFamily:FONT_UI,marginTop:2}}>
                    {v.vendedor||"—"} · {v.metodoPago||"—"} · {v.hora||"—"}
                  </div>
                </div>
...
function MarcaDetalle({marcaId,inv,ventas,vMes,mes,anio,MK,cierres,setCierres,getHist,getLiq,auditorias=[],onActualizarAuditoria,user,retiros=[],onVentaClick}){
  ...
  // Parsea fecha en formato ISO "2026-06-13" O "13/6/2026" → {anio, mes0, mk}
  function parseFechaRetiro(fecha){
    ...
    if(fecha.includes("-")){
      ...
      // ISO: YYYY-MM-DD
      const anio=parseInt(p[0]), mes1=parseInt(p[1]);
      if(anio>1000) return {anio, mes0:mes1-1, mk:`${p[0]}-${p[1].padStart(2,"0")}`};
    }
    if(fecha.includes("/")){
      const p = fecha.split("/");
      if(p.length<3) return null;
      // DD/M/YYYY o DD/MM/YYYY
      const anio=parseInt(p[2]), mes1=parseInt(p[1]);
      return {anio, mes0:mes1-1, mk:`${p[2]}-${String(mes1).padStart(2,"0")}`};
    }
    return null;
  }
    ...
    <div>
      ...
      <div style={{background:C.bg2,borderRadius:16,padding:16,marginBottom:16,
        ...
        <div style={{marginTop:12,padding:"10px 12px",background:C.bg3,borderRadius:10,
          ...
          <span style={{fontSize:14,fontWeight:700,color:totalPer>0?C.gold:C.label3,fontFamily:FONT}}>
        ...
        <div style={{padding:"18px 20px 14px",borderBottom:`1px solid ${C.sep}`,
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
            <div>
              ...
              <div style={{fontSize:19,fontWeight:600,color:C.label,fontFamily:FONT_DISPLAY}}>
  ...
  return (
    <div>
      ...
      <div style={{marginBottom:22}}>
        <div style={{fontSize:24,fontWeight:600,color:C.label,fontFamily:FONT_DISPLAY,
        ...
        <div>
          <div style={{background:C.bg1,borderRadius:20,padding:20,marginBottom:20,
            ...
            <div style={{display:"flex",alignItems:"center",gap:16,marginBottom:16,
              ...
              <div>
                <div style={{fontSize:20,fontWeight:600,color:C.label,
      ...
      {tempPass&&(
        <div style={{position:"fixed",inset:0,zIndex:700,
          ...
          <div style={{background:C.bg1,borderRadius:28,padding:28,
            ...
            <div style={{fontSize:18,fontWeight:600,color:C.label,fontFamily:FONT,
      ...
      {vistaD==="dashboard"&&(
        <div>
          ...
          <div style={{background:C.blue,borderRadius:16,padding:"20px 24px",marginBottom:12,
            ...
            <div style={{fontSize:32,fontWeight:700,color:"#fff",fontFamily:FONT,lineHeight:1}}>
              {$(totalFil)}
            </div>
        ...
        <div>
          {porMarca.length===0
            ...
            : porMarca.map((x,i)=>(
                <div key={x.marca.id} style={{
                  background:C.bg2,
                  borderRadius:i===0?"14px 14px 4px 4px":i===porMarca.length-1?"4px 4px 14px 14px":"4px",
                  borderBottom:i<porMarca.length-1?`1px solid ${C.sep}`:"",
                  padding: isDesktop ? "9px 14px" : "12px 14px",
                  cursor:"pointer",
                  WebkitTapHighlightColor:"transparent",
                  borderLeft:`3px solid ${x.marca.color}`,
                ...
                onClick={()=>{setMarcaFiltro(marcaFiltro===x.marca.id?null:x.marca.id);setVistaActiva("historial");}}>
                  {/* Cabecera marca */}
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom: isDesktop ? 5 : 8}}>
                    <div style={{display:"flex",alignItems:"center",gap: isDesktop ? 8 : 10}}>
                      <div style={{width: isDesktop ? 28 : 32, height: isDesktop ? 28 : 32, borderRadius:9,
                        background:`${x.marca.color}22`,display:"flex",
                        alignItems:"center",justifyContent:"center",flexShrink:0}}>
                        <MarcaIcon marca={x.marca} size={isDesktop ? 16 : 18} radius={5}/>
                      </div>
                      <div>
                        <div style={{fontSize: isDesktop ? 13 : 14, fontWeight:600, color:C.label, fontFamily:FONT}}>{x.marca.nombre}</div>
                        <div style={{fontSize:10,color:C.label3,fontFamily:FONT,opacity:.65}}>{x.txs} venta{x.txs!==1?"s":""}</div>
                      </div>
                    </div>
                    <div style={{textAlign:"right"}}>
                  ...
                  {/* Barra total */}
                  <div style={{background:"rgba(0,0,0,0.05)",borderRadius:4,height: isDesktop ? 3 : 4, marginBottom: isDesktop ? 5 : 8, overflow:"hidden"}}>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap: isDesktop ? 5 : 7}}>
                    {[
                      ...
                      <div key={p.label} style={{
                        ...
                        {p.value>0&&x.total>0&&(
                          <div style={{fontSize:9,color:C.label3,fontFamily:FONT,opacity:.7}}>
